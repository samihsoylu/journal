                        ...
                        <a href="{{ $user_url }}/{{ $user->getId() }}">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <p>Created: {{ $user->getCreatedTimestampFormatted($session->getTimezone()) }} <span title="Privilege" class="card-text-right light-grey-text italic">{{ $user->getPrivilegeLevelAsString() }}</span></p>
                                </div>
                            </div>
                        </a>
                    @endforeach
