...
/**
 * Factory for creating Entry entities in tests.
 *
 * Usage:
...
final class EntryFactory
{
    ...
    private string $title = 'Test Entry';
    private string $content = 'Test entry content';
