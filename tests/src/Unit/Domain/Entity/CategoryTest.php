...
it('should not throw an exception if all required properties are provided', function () {
    $category = new Category();
...
it('should correctly get and set user', function () {
    $category = new Category();
...
it('should correctly get and set name', function () {
    $category = new Category();
    $category->setName('Test Category');
...
it('should correctly get and set description', function () {
    $category = new Category();
    $category->setDescription('This is a test description');
...
it('should correctly get and set position', function () {
    $category = new Category();
    $category->setPosition(1);
